...
- ANCOVA gives
    - MHC_SF_OVERALL ~ gender + age_group + week_soc_distancing + athlete + HADS_OVERALL + LONE_TOTAL
- Group Lasso gives
    - MHC_SF_OVERALL ~ gender + age_group + fivfruitveg + week_soc_distancing + athlete + HADS_OVERALL + RES_TOTAL + LONE_TOTAL
